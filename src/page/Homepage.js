                ...
                <div className="card rounded-0 border-0 mb-3 bg-light-gray">
                  ...
                  <div className="card-body">
                    <div className="d-flex align-items-md-center mb-3">
                      ...
                      <div className="d-md-flex align-items-center justify-content-between w-100">
                        ...
                        <div className="d-flex align-items-center">
                          ...
                          <button className="border-0 bg-transparent d-flex align-items-center me-3" onClick={handleLikeClick}> <span className="material-icons me-1 font-16 like-icon">
                            thumb_up
                          </span> <span>{likeCount}</span>
                          </button>

                          <button className="border-0 bg-transparent d-flex align-items-center" onClick={handleDislikeClick}> <span className="material-icons me-1 font-16 dislike-icon">
                            thumb_down
                    ...
                    <div className="post-description">
                      ...
                      <div className="d-flex align-items-start mb-md-4 mb-3">
                        <div className="post-img me-3">
                          <img src={profile_4} className="img-fluid"></img>
                        </div>
